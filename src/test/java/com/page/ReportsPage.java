...
public class ReportsPage  {
    ...
    private static final SelenideElement buttonChooseDate = $x("(//div[@class='select-date-calendar'])[2]");
    private static final SelenideElement buttonChooseDay = $x("//div[@class='react-datepicker__day react-datepicker__day--001']");
